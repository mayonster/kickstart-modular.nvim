-- Lualine because I wanted more prettier than mini.statusline
--
...
return {
  ...
  -- Default Theme Colors: Define a set of base colors for your theme
    config = function()
      local colors = {
        BG = '#17003d', -- Dark background
        FG = '#6e15ff', -- Light foreground for contrast
        YELLOW = '#ffd400', -- Vibrant yellow
        CYAN = '#0ef3ff', -- Soft cyan
        DARKBLUE = '#020d22', -- Deep blue
        GREEN = '#13db77', -- Bright green
        ORANGE = '#cf4c00', -- Warm orange
        VIOLET = '#6e15ff', -- Strong violet
